...
(defn- pom-template [version]
  [[:description "using Jank in Quarto documents"]
   [:url "https://github.com/scicloj/janqua"]
   [:licenses
    [:license
     [:name "MIT License"]
   ...
   [:scm
    [:url "https://github.com/scicloj/janqua"]
    [:connection "scm:git:https://github.com/scicloj/janqua.git"]
    [:developerConnection "scm:git:ssh:git@github.com:scicloj/janqua.git"]
    [:tag (str "v" version)]]])
