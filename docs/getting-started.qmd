...
- See [Authoring Jank documents](authoring.qmd) for Kindly annotations, fence attributes, and per-block options
- See the [Demo](example.qmd) for evaluated examples
