...
Note the `{.jank}` syntax — the dot prefix is required (it's [Pandoc class syntax](https://pandoc.org/MANUAL.html#divs-and-spans)). The `filters: [jank]` in the [frontmatter](https://quarto.org/docs/authoring/front-matter.html) tells Quarto to use the Janqua filter.
