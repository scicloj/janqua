...
The wrapped code is sent to Jank via [`clj-nrepl-eval`](https://github.com/bhauman/clojure-mcp-light), a Babashka-based nREPL client. The filter parses the response to extract:
